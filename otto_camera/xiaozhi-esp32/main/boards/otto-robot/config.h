...
/* Camera PINs*/
#define SPARKBOT_CAMERA_XCLK      (GPIO_NUM_48)
#define SPARKBOT_CAMERA_PCLK      (GPIO_NUM_45)
#define SPARKBOT_CAMERA_VSYNC     (GPIO_NUM_21)
#define SPARKBOT_CAMERA_HSYNC     (GPIO_NUM_47)
#define SPARKBOT_CAMERA_D0        (GPIO_NUM_42)
#define SPARKBOT_CAMERA_D1        (GPIO_NUM_1)
#define SPARKBOT_CAMERA_D2        (GPIO_NUM_2)
#define SPARKBOT_CAMERA_D3        (GPIO_NUM_44)
#define SPARKBOT_CAMERA_D4        (GPIO_NUM_41)
#define SPARKBOT_CAMERA_D5        (GPIO_NUM_40)
#define SPARKBOT_CAMERA_D6        (GPIO_NUM_12)
#define SPARKBOT_CAMERA_D7        (GPIO_NUM_8)
...
#define SPARKBOT_LEDC_TIMER       (LEDC_TIMER_1)
#define SPARKBOT_LEDC_CHANNEL     (LEDC_CHANNEL_0)

#define SPARKBOT_CAMERA_SIOD      (GPIO_NUM_13)
#define SPARKBOT_CAMERA_SIOC      (GPIO_NUM_14)
// #define SPARKBOT_CAMERA_SIOD      (GPIO_NUM_NC)
// #define SPARKBOT_CAMERA_SIOC      (GPIO_NUM_NC)

#define AUDIO_CODEC_I2C_SDA_PIN  SPARKBOT_CAMERA_SIOD
#define AUDIO_CODEC_I2C_SCL_PIN  SPARKBOT_CAMERA_SIOC
