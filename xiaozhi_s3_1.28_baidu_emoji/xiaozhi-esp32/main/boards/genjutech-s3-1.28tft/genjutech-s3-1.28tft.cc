...
#define TAG "GenJuTech_s3_1_28TFT"
...
class GenJuTech_s3_1_28TFT : public WifiBoard {
private:
    Button boot_button_;
    ...
    void InitializeGc9a01Display() {
        ...
        display_ = new EmojiDisplay(io_handle, panel_handle,DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_OFFSET_X, DISPLAY_OFFSET_Y,
...
public:
    GenJuTech_s3_1_28TFT() :
        boot_button_(BOOT_BUTTON_GPIO),
        volume_up_button_(VOLUME_UP_BUTTON_GPIO),
        volume_down_button_(VOLUME_DOWN_BUTTON_GPIO) {
        ESP_LOGI(TAG, "Initializing GenJuTech S3 1.28 Board");
...
DECLARE_BOARD(GenJuTech_s3_1_28TFT);
